...
// SetDefaults_BinPackArgs sets the defaults parameters for BinPack Plugin.
func SetDefaults_BinPackArgs(obj *BinPackArgs) {
	if obj.BinPackingMemory == 0 {
		obj.BinPackingMemory = 1
	}

	if obj.BinPackingCPU == 0 {
		obj.BinPackingCPU = 1
	}
}
