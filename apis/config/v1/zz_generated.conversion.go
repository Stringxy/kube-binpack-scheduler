...
func RegisterConversions(s *runtime.Scheme) error {
	if err := s.AddGeneratedConversionFunc((*BinPackArgs)(nil), (*config.BinPackArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_BinPackArgs_To_config_BinPackArgs(a.(*BinPackArgs), b.(*config.BinPackArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.BinPackArgs)(nil), (*BinPackArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_BinPackArgs_To_v1_BinPackArgs(a.(*config.BinPackArgs), b.(*BinPackArgs), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1_BinPackArgs_To_config_BinPackArgs(in *BinPackArgs, out *config.BinPackArgs, s conversion.Scope) error {
	out.BinPackingCPU = int64(in.BinPackingCPU)
	out.BinPackingMemory = int64(in.BinPackingMemory)
	return nil
}

// Convert_v1_BinPackArgs_To_config_BinPackArgs is an autogenerated conversion function.
func Convert_v1_BinPackArgs_To_config_BinPackArgs(in *BinPackArgs, out *config.BinPackArgs, s conversion.Scope) error {
	return autoConvert_v1_BinPackArgs_To_config_BinPackArgs(in, out, s)
}

func autoConvert_config_BinPackArgs_To_v1_BinPackArgs(in *config.BinPackArgs, out *BinPackArgs, s conversion.Scope) error {
	out.BinPackingCPU = int(in.BinPackingCPU)
	out.BinPackingMemory = int(in.BinPackingMemory)
	return nil
}

// Convert_config_BinPackArgs_To_v1_BinPackArgs is an autogenerated conversion function.
func Convert_config_BinPackArgs_To_v1_BinPackArgs(in *config.BinPackArgs, out *BinPackArgs, s conversion.Scope) error {
	return autoConvert_config_BinPackArgs_To_v1_BinPackArgs(in, out, s)
}
